                ...
                <div class="row">
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    <table id="tabelMemo" class="table table-striped table-responsive table-bordered tabelKomentar">
                                        <thead>
                                            <tr>
                                                <th>--</th>
                                                <th>Nomor</th>
                    ...
                    <div class="col-md-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <div class="table-responsive">
                                    <table id="tabelBarang" class="table table-striped table-responsive table-bordered tabelKomentar">
                                        <thead>
                                            <tr>
                                                <th>--</th>
                                                <th>Nomor</th>
